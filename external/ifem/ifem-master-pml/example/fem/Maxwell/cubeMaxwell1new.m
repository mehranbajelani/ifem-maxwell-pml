...
sigma = 0.0;                       % S/m (set small >0 to avoid resonances)
...
% Mark ALL cube boundary faces as Dirichlet (PEC: n x E = 0)
bdFlag = setboundary3(node, elem, 'Dirichlet');   % (use your usual signature)
% If your version needs explicit faces, use the variant that tags all outer faces.
